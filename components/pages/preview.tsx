...
const sidePreviewStyle = 'rounded-lg text-center bg-gray-300 px-10 py-2 my-5 min-w-[300px] max-w-[300px]'
...
const Preview = () => {
    ...
    return (
        <>
            ...
            <div className='rounded-lg text-center flex-1 bg-red-400 mx-10 py-5 min-w-[500px]'>
